...
grassRange = [round(grassYmean - 2.5*grassYstd), round(grassYmean + 2.5*grassYstd);
             round(grassCbmean - 2.5*grassCbstd), round(grassCbmean + 2.5*grassCbstd);
             round(grassCrmean - 2.5*grassCrstd), round(grassCrmean + 2.5*grassCrstd)];

soilRange = [round(soilYmean - 2.5*soilYstd), round(soilYmean + 2.5*soilYstd);
             round(soilCbmean - 2.5*soilCbstd), round(soilCbmean + 2.5*soilCbstd);
             round(soilCrmean - 2.5*soilCrstd), round(soilCrmean + 2.5*soilCrstd)];
